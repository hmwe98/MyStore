...
namespace EndPoint.Site.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public AuthenticationController(IRegisterUserService
            registerUserService, IUserLoginService userLoginService)
        {
        ...
        public IActionResult Signup(SignupViewModel request)
        {
            ...
            if (User.Identity.IsAuthenticated == true)
            {
                return Json(new ResultDto { IsSuccess = false,
                    Message = "شما به " +
                    "حساب کاربری خود وارد شده اید! و در حال " +
                    "حاضر نمیتوانید ثبت نام مجدد نمایید" });
            }
            ...
            if (signeupResult.IsSuccess == true)
            {
                ...
                ,signeupResult.Data.UserId.ToString()),
            ...
            string Password, string url = "/")
        {
            ...
            if (signupResult.IsSuccess == true)
            {
                ...
                {
                    new Claim(ClaimTypes.NameIdentifier,
                    signupResult.Data.UserId.ToString()),
