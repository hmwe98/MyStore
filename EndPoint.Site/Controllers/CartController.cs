...
namespace EndPoint.Site.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var resultGetLst = _cartService.GetMyCart
                 (cookiesManeger.GetBrowserId(HttpContext), userId);
        ...
        public IActionResult AddToCart(long ProductId)
        {
           ...
           var resultAdd= _cartService.AddToCart(ProductId, 
               cookiesManeger.GetBrowserId(HttpContext));
