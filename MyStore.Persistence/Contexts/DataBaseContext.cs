...
namespace MyStore.Persistence.Contexts
{
    public class DataBaseContext : DbContext, IDataBaseContext
    {
        ...
        {
            modelBuilder.Entity<Role>().HasData(new Role { Id = 1, Name = nameof(UserRoles.Admin),RemoveTime=null,UpdateTime=null });
            modelBuilder.Entity<Role>().HasData(new Role { Id = 2, Name = nameof(UserRoles.Operator), RemoveTime = null, UpdateTime = null });
            modelBuilder.Entity<Role>().HasData(new Role { Id = 3, Name = nameof(UserRoles.Customer), RemoveTime = null, UpdateTime = null });
        }
